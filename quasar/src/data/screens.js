...
{id:'P34',phase:5,type:'multi',title:['What benefits matter most to you?','¿Qué beneficios te importan más?'],
 opts:[{i:'sun',t:['Flexible PTO','PTO flexible']},{i:'shieldcheck',t:['Health insurance','Seguro médico']},{i:'house',t:['Home office budget','Presupuesto para oficina en casa']},{i:'laptop',t:['Equipment provided','Equipo proporcionado']},{i:'family',t:['Parental leave','Baja parental']},{i:'book',t:['Learning budget','Presupuesto de formación']},{i:'growth',t:['Career advancement','Desarrollo de carrera']},{i:'heartD',t:['Mental health support','Apoyo a salud mental']},{i:'mic',t:['Conference expenses','Gastos de conferencias']},{i:'globe',t:['International opportunities','Oportunidades internacionales']},{i:'medal',t:['Wellness programs','Programas de bienestar']}]},
...
{id:'P46',phase:5,type:'multi',title:['What stops you from applying to more jobs?','¿Qué te impide aplicar a más empleos?'],
 opts:[{i:'hourglass',t:["I don't have enough time",'No tengo suficiente tiempo']},{i:'meh',t:['Forms are exhausting','Los formularios agotan']},{i:'eye',t:['Too many options to track','Demasiadas opciones que seguir']},{i:'clockfull',t:['Deadlines pass too quickly','Los plazos pasan demasiado rápido']},{i:'docdash',t:['Lose track of applications','Pierdo el hilo de mis candidaturas']},{i:'compass',t:['Get distracted from applying','Me distraigo y no aplico']}]},
